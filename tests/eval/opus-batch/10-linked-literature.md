...
Resolve rs4149056 in SLCO1B1 and retrieve one linked annotation and one source-linked literature record or PMID. Return the IDs, exact stored titles where present, the explicit linking evidence, and source timestamps. Do not infer an unsupported relationship merely from shared search words.
