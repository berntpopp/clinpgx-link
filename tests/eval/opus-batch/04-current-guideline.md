...
Retrieve the current ClinPGx guideline annotation for clopidogrel and CYP2C19. Return its exact title, stable ID, source organization, URL, and live retrieval timestamp. Identify the mounted snapshot separately; do not infer a treatment action.
