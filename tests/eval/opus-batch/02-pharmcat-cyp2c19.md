...
Find the installed PharmCAT CYP2C19 *2/*2 diplotype row. Return all five exact stored fields: diplotype, diplotypekey (including its numeric value), generesult, lookupkey, and phenotype. Include the stable row ID, member, snapshot identity, and source evidence. Do not infer treatment.
