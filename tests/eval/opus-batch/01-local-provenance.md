...
Find the installed DPYD gene row. Return its exact symbol and Alternate Names field, stable row ID, source member, gene archive SHA-256, and mounted snapshot/release identity. Distinguish local re-admission time from upstream publication or fresh remote retrieval; report unknown dates as unknown.
