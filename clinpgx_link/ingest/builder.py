...
from clinpgx_link.data.gene_alias_membership import gene_alias_membership_receipt
...
def _create_database(
    ...
    try:
        ...
        gene_alias_membership = gene_alias_membership_receipt(snapshot_id)
        manifest = {
            "build_config": build_config,
            "schema_version": _SCHEMA_VERSION,
            "snapshot_id": snapshot_id,
            ...
            "gene_alias_membership": gene_alias_membership,
        }
        connection.execute(
        ...
        connection.execute(
            "INSERT INTO metadata(key,value) VALUES ('gene_alias_membership_json',?)",
            (_canonical_json(gene_alias_membership),),
        )
        connection.execute(
